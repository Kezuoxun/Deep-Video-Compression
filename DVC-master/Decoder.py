...
def decoder(loadmodel, refer_path, outputfolder):
    ...
    reconframe = 'import/build_towers/tower_0/train_net_inference_one_pass/train_net/ReconFrame:0'
    res_input = 'import/quant_feature:0'  #
    res_prior_input = 'import/quant_z:0'
    motion_input = 'import/quant_mv:0'
    previousImage = 'import/input_image_ref:0'
    ...
    with tf.compat.v1.Session(graph=graph) as sess:
        ...
        # check 
        # imagedir = './image/'
        # im2 = cv.imread(imagedir + 'im003.png')
        # im2 = im2 / 255.0
